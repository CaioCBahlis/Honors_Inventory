...
export function ROMModal({onClose, FormID, FormComponent, ModalTitle}: { onClose: () => void, FormID: string, FormComponent: React.FC<{ id: string, onClose: () => void}>, ModalTitle: string}){
    return (
        <div className={"Modal"} id={"Create"}>
            <div id={"Form"}>
                <h2 id={"Modal-Title"}> {ModalTitle} </h2>

                 <FormComponent id={FormID} onClose={onClose}/>
